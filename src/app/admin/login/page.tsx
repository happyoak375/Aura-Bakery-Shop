    ...
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-6 font-sans">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-500 text-sm mt-2">solo personal autorizado</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          */}
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-black text-white text-lg font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-all hover:bg-zinc-800 active:scale-95 mt-4 disabled:opacity-70"
          >
